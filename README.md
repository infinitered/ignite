...
Once you're up and running, check out our new [Getting Started](https://github.com/infinitered/ignite/blob/master/docs/Getting-Started.md) guide or the rest of our [docs](https://github.com/infinitered/ignite/blob/master/docs).
