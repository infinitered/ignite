    ...
    <Card
      ...
      FooterComponent={
        <Button
          ...
          onLongPress={handlePressFavorite}
          style={themed([$favoriteButton, isFavorite && $favoriteButtonFavorited])}
          textStyle={themed([$favoriteButtonText, isFavorite && $favoriteButtonTextFavorited])}
          accessibilityLabel={
            isFavorite
          ...
          text={
            isFavorite
              ? translate("demoPodcastListScreen:unfavorite")
              : translate("demoPodcastListScreen:favorite")
          }
...
const $iconContainer: ViewStyle = {
  ...
  flexDirection: "row",
  marginEnd: 4,
  paddingTop: 2, // finicky and will depend on font/line-height/platform/weather
  alignSelf: "flex-start",
  position: "absolute",
}
...
const $favoriteButtonText: ThemedStyle<TextStyle> = ({ colors }) => ({
  fontSize: 12,
  lineHeight: 15,
  fontWeight: "500",
...
const $favoriteButtonFavorited: ThemedStyle<ViewStyle> = ({ colors }) => ({
  borderColor: colors.palette.primary400,
  backgroundColor: colors.palette.primary400,
})

const $favoriteButtonTextFavorited: ThemedStyle<TextStyle> = ({ colors }) => ({
