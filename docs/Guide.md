...
Once it's up and running, you can use the Ignite CLI to [generate](./concept-docs/Generators.md) components, screens, MST models, and more.

Running into errors? have a look at [upgrading Ignite CLI](./cli-docs/Upgrading-Ignite.md)
...
- About a dozen prebuilt [components](./boilerplate-docs/component-docs/Components.md) to build out your UI with
- And more!
...
Learn more in our [Navigation](./concept-docs/Navigation.md) documentation.
...
Check out the [Components](./boilerplate-docs/component-docs/Components.md) documentation.
...
You can learn more about why we chose these tests and how to use them in the [Testing](./concept-docs/Testing.md) docs.
...
Very often, we use [components with presets](./boilerplate-docs/component-docs/Components.md) to share styles across our whole app.

Read more about styling in the [Styling](./concept-docs/Styling.md) docs.
