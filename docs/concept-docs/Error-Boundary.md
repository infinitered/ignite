...
Ignite provides utilities in [`/app/utils/crash-reporting.ts`](../boilerplate-docs/app/utils/crash-reporting.ts) to integrate these services into your app.

## Examples

- See our [`ErrorBoundary` component](../boilerplate-docs/app/screens/ErrorScreen/ErrorBoundary.tsx) for error catching logic
- See our [`ErrorScreen` component](../boilerplate-docs/app/screens/ErrorScreen/ErrorDetails.tsx) for error fallback UI
