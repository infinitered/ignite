...
```tsx
<Header titleText="Title" leftIcon="back" onLeftPress={() => navigation.goBack()} />
```
...
```tsx
<Header titleText="Title" leftText="Back" onLeftPress={() => navigation.goBack()} />
```
...
```tsx
<Header titleText="Title" LeftActionComponent={<Text>Back</Text>} />
```
...
```tsx
<Header titleText="Title" rightIcon="back" onRightPress={() => navigation.goBack()} />
```
...
```tsx
<Header titleText="Title" rightText="Back" onRightPress={() => navigation.goBack()} />
```
...
```tsx
<Header titleText="Title" RightActionComponent={<Text>Back</Text>} />
```
...
```tsx
<Header titleText="Title" safeAreaEdges={[]} />
```
...
function AccountScreen(props) {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({ headerShown: true, header: () => <Header title="Hello" /> })
  }, [])
