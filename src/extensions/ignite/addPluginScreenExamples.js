  ...
  async function addPluginScreenExamples (files, props = {}) {
    ...
    if (config.examples === 'classic') {
      ...
      if (fileName.endsWith('.ejs')) {
        ...
        print.warning(`DEPRECATION WARNING: addPluginScreenExample called with '${filename}' and no .ejs extension. Add .ejs to your filename when calling this function.`)
